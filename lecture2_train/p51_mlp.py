...
# neural network establishment
# class style
'''class MLP(Model):
    def __init__(self):
        super(MLP, self).__init__()
        self.layer1 = Dense(4,activation='relu')
        self.layer2 = Dense(3,activation='softmax')
    def call(self,x):
...
'''def MLP():
    ...
    output = Dense(3,activation='softmax',name='classification')(hidden)
...
checkpoint_pth = './checkpoint/mlp.ckpt'
