...
# refer to https://github.com/ndrplz/ConvLSTM_pytorch

class ConvLSTMCell(torch.nn.Module):
    """
    ConvLSTM cell Parameters:
    input_dim: int
...
class ConvLSTM(torch.nn.Module):
    ...
    Input:
        A tensor of size B, T, C, H, W or T, B, C, H, W
            T - time steps, B - batch size, C - channels, H - height, W - width
    Output:
...
if __name__=='__main__':
    ...
    convlstm = ConvLSTM(input_dim=3, hidden_dim=16, kernel_size=(3,3), num_layers=1, batch_first=True)
